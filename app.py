...
st.write("Загрузите Excel-файл из Кунделика. Приложение автоматически построит цветные диаграммы и сформирует корректный PDF отчет")

uploaded = st.file_uploader("Загрузите файл Excel", type=["xlsx"]) 
